...
Existem diversas formas de salvar essas estatísticas, mas recomendamos o uso da função `augment()` do pacote `broom`. Ela precisa de dois argumento: `x` que especifica o modelo e `data` que especifica os dados usados para gerar o modelo.
