---
title: "Roteiro 1 - Introdução ao software R/RStudio"
...
objetos, funções, dados estruturados, operadores lógicos,
...
No decorrer deste curso, os softwares R/RStudio serão usados como uma **ferramenta** para auxiliar na aplicação de **métodos e técnicas de análise da informação**, uma etapa fundamental em pesquisas que buscam um aumento da compreensão de questões no nosso campo de interesse.
...
Dados estruturados (tabela ou *data frame*)
...
Infelizmente, a maior parte do conteúdo está escrito em inglês, assim como em outras linguagens de programação. :worried:
