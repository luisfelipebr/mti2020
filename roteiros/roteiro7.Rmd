...
O modelo SAR não é significativo neste caso (p-valor > 0,05), indicado pelo p-valor do teste dos resíduos da aucorrelação espacial (0,22) e do intercepto (0,09). Se ele fosse significativo, o AIC (33.908) seria menor que o AIC do modelo de regressão linear (35.289), indicando um melhor resultado.
